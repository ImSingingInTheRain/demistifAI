"""Stage navigation components shared across demistifAI stages."""
...
try:  # pragma: no cover - optional app config module
    from demistifai.config.app import STAGES, STAGE_BY_KEY  # type: ignore
except Exception:  # pragma: no cover - guard against missing optional module
    STAGES, STAGE_BY_KEY = [], {}
...
def _render_stage_navigation_controls(
    ...
    prev_clicked = prev_slot.button(
        ...
        help="Return to the previous stage",
    )
