...
def render_demai_architecture(nerd_mode: bool = False, active_stage: str | None = None):
    """
    Native Streamlit component (no iframe) that renders an interactive
    'demAI machine' architecture diagram with concentric layers and flip cards.
    ...
    <style>
      .demai-arch {{
        ...
        box-shadow: inset 0 0 0 1px var(--ring3);
